...
def experiment():
    ...
    optimal_average_reward_per_timestep = 4.92  # set the optimal average reward per timestep you found in the DP assignment here
    ...
    for temp in temps:
        learning_curve = average_over_repetitions(backup, n_repetitions, n_timesteps, max_episode_length, learning_rate,
                                                  gamma, policy, epsilon, temp, smoothing_window, plot, n)
        Plot.add_curve(learning_curve, label=r'boltzmann, $ \tau $ = {}'.format(temp))
